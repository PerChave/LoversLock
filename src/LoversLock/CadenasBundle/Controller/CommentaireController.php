...
use LoversLock\CadenasBundle\Entity\Commentaire;
use LoversLock\CadenasBundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LoversLockCadenasBundle:Commentaire')->findAll();
     ...
     * @Method("POST")
     * @Template("LoversLockCadenasBundle:Commentaire:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LoversLockCadenasBundle:Commentaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LoversLockCadenasBundle:Commentaire:edit.html.twig")
     */
