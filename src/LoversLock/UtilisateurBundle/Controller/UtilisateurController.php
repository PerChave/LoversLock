...
namespace LoversLock\UtilisateurBundle\Controller;
...
use LoversLock\UtilisateurBundle\Form\UtilisateurType;
...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LoversLockUtilisateurBundle:Utilisateur')->findAll();
     ...
     * @Method("POST")
     * @Template("LoversLockUtilisateurBundle:Utilisateur:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LoversLockUtilisateurBundle:Utilisateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LoversLockUtilisateurBundle:Utilisateur:edit.html.twig")
     */
